...
mod tests {
    ...
    fn test_get_all_blocks_for_window_missing_blocks() {
        ...
        // Fetch all blocks for a window size of 3, and ensure it returns round 4 and 5 (round 3 is missing)
        let all_pipelined_blocks = get_all_pipelined_blocks_for_window(
            pending_block_store.clone(),
            &ordered_block_round_five,
            3,
        ...
        // Fetch all blocks for a window size of 4, and ensure it returns round 4 and 5 (round 3 is missing)
        let all_pipelined_blocks = get_all_pipelined_blocks_for_window(
            pending_block_store.clone(),
            &ordered_block_round_five,
            4,
